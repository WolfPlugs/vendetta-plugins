...
const support = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <path
...
export default ({color}) => <SvgXml height={24} width={24} resizeMode="contain" marginHorizontal={4} xml={support} fill={color} />