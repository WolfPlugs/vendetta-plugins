...
const translator = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <path
      fill="#7289da"
...
export default () => <SvgXml height={24} width={24} resizeMode="contain" marginHorizontal={4} xml={translator} />